...
const newLeadScreen = ({navigation}: any) => {
  ...
  const createTicketManager = async () => {
    if (title.length === 0) {
      return SimpleToast.show('Please select ticket type');
    }
    setLoading(true);
    try {
      let data = {
        ...
        <KeyboardAwareScrollView
          ...
          <View style={styles.contanier}>
            ...
            <View
              ...
              <CustomInput
                black
                placeholder="Sales Territory ID"
                value={description}
                action={setDescription}
              />
            </View>
            ...
            {/* <View
              style={[
                {height: getScreenHeight(6),marginTop:getScreenHeight(2.5)},
